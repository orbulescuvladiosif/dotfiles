...
- Check skill naming — verb-first kebab-case; `$skillNames` in `install.ps1` must list every `ai/skills/*.md`; Claude maps to `commands/`; Cursor maps to `~/.cursor/skills/<name>/SKILL.md` with `name`, `description`, `disable-model-invocation: true`
